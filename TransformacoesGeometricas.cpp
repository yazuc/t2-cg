...
void CarregaModelos()
{
    ...
    Modelos[0].leModelo("Jogador.txt");
    Modelos[1].leModelo("NaveCargueiro.txt");
...
void CriaInstancias()
{
    ...
    // Calcula a translação para colocar o mapa do RS no centro
    Ponto A, B, Meio;
    ...
    Personagens[3].Posicao = Ponto (3,3);
    Personagens[3].Rotacao = 0;
    Personagens[3].IdDoModelo = 1;
    Personagens[3].modelo = DesenhaPersonagemMatricial;
